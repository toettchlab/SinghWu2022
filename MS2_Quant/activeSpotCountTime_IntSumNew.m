function spotCountFinal=activeSpotCountTime_IntSumNew(roiPlots,statslist_spot)
...
statslist_spot(:,2)>60 & statslist_spot(:,2)<460);
...
% for iColor=1:size(myStatData,2)
 for iPlots = min(statslist_spotFilt{1,mRoi}(:,7)):max(statslist_spotFilt{1,mRoi}(:,7))
% 
% %   
     index01 = ((statslist_spotFilt{1,mRoi}(:,7)) == iPlots);
