function [myImg,bw3,Stats]=segNucZoom5_stdDev_PrevROI(imgfile,nucOffset)
...
% if isequal(timeWindowPrevID{1,1:size(numberOfLightON,1)},iFiles)
%     bwCrop= bw3Spot(:,415:625,iFiles);
% 
%     
% end
